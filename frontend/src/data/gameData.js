...
// ─── TALENT BOOKS ─────────────────────────────────────────────────────────────
const WI = 'https://static.wikia.nocookie.net/gensin-impact/images'
export const TALENT_BOOKS = {
  // Mondstadt
  freedom:    {name:'Freedom',    color:'#4a9eff', icon:`${WI}/1/1a/Item_Guide_to_Freedom.png`},
  resistance: {name:'Resistance', color:'#4a9eff', icon:`${WI}/b/bf/Item_Guide_to_Resistance.png`},
  ballad:     {name:'Ballad',     color:'#4a9eff', icon:`${WI}/2/2f/Item_Guide_to_Ballad.png`},
  // Liyue
  prosperity: {name:'Prosperity', color:'#f5a623', icon:`${WI}/6/67/Item_Guide_to_Prosperity.png`},
  diligence:  {name:'Diligence',  color:'#f5a623', icon:`${WI}/9/9f/Item_Guide_to_Diligence.png`},
  gold:       {name:'Gold',       color:'#f5a623', icon:`${WI}/4/43/Item_Guide_to_Gold.png`},
  // Inazuma
  transience: {name:'Transience', color:'#c678dd', icon:`${WI}/b/b0/Item_Guide_to_Transience.png`},
  elegance:   {name:'Elegance',   color:'#c678dd', icon:`${WI}/d/df/Item_Guide_to_Elegance.png`},
  light:      {name:'Light',      color:'#c678dd', icon:`${WI}/f/fe/Item_Guide_to_Light.png`},
  // Sumeru
  admonition: {name:'Admonition', color:'#98c379', icon:`${WI}/7/72/Item_Guide_to_Admonition.png`},
  ingenuity:  {name:'Ingenuity',  color:'#98c379', icon:`${WI}/a/ab/Item_Guide_to_Ingenuity.png`},
  praxis:     {name:'Praxis',     color:'#98c379', icon:`${WI}/a/a1/Item_Guide_to_Praxis.png`},
  // Fontaine
  equity:     {name:'Equity',     color:'#56b6c2', icon:`${WI}/c/ce/Item_Guide_to_Equity.png`},
  justice:    {name:'Justice',    color:'#56b6c2', icon:`${WI}/e/ea/Item_Guide_to_Justice.png`},
  order:      {name:'Order',      color:'#56b6c2', icon:`${WI}/2/2a/Item_Guide_to_Order.png`},
  // Natlan
  conflict:   {name:'Conflict',   color:'#e06c75', icon:`${WI}/f/f7/Item_Guide_to_Conflict.png`},
  contention: {name:'Contention', color:'#e06c75', icon:`${WI}/a/a9/Item_Guide_to_Contention.png`},
  kindling:   {name:'Kindling',   color:'#e06c75', icon:`${WI}/2/22/Item_Guide_to_Kindling.png`},
  // Nod-Krai
  elysium:    {name:'Elysium',    color:'#9e8cdb', icon:`${WI}/d/d9/Item_Guide_to_Elysium.png`},
  moonlight:  {name:'Moonlight',  color:'#9e8cdb', icon:`${WI}/b/b1/Item_Guide_to_Moonlight.png`},
  vagrancy:   {name:'Vagrancy',   color:'#9e8cdb', icon:`${WI}/a/a5/Item_Guide_to_Vagrancy.png`},
}
...
// ─── CHARACTERS ───────────────────────────────────────────────────────────────
// id, name, element, rarity, weaponType, talentBook, weaponMat, weeklyBoss, region
// weeklyBoss: weekly boss id whose drops are needed for this character's talent upgrades
export const CHARACTERS = [
  // ── Mondstadt ──
  {id:'albedo',       name:'Albedo',          element:'Geo',     rarity:5, weaponType:'Sword',    talentBook:'ballad',      weaponMat:'talisman_soldier', weeklyBoss:'w_childe',      region:'Mondstadt'},
  {id:'amber',        name:'Amber',           element:'Pyro',    rarity:4, weaponType:'Bow',      talentBook:'freedom',     weaponMat:'decarabian',       weeklyBoss:'w_dvalin',         region:'Mondstadt'},
  {id:'barbara',      name:'Barbara',         element:'Hydro',   rarity:4, weaponType:'Catalyst', talentBook:'freedom',     weaponMat:'dandelion_gladiator',weeklyBoss:'w_wolf',       region:'Mondstadt'},
  {id:'bennett',      name:'Bennett',         element:'Pyro',    rarity:4, weaponType:'Sword',    talentBook:'resistance',  weaponMat:'dandelion_gladiator',weeklyBoss:'w_dvalin',       region:'Mondstadt'},
  {id:'diluc',        name:'Diluc',           element:'Pyro',    rarity:5, weaponType:'Claymore', talentBook:'resistance',  weaponMat:'decarabian',       weeklyBoss:'w_dvalin',         region:'Mondstadt'},
  {id:'diona',        name:'Diona',           element:'Cryo',    rarity:4, weaponType:'Bow',      talentBook:'freedom',     weaponMat:'dandelion_gladiator',weeklyBoss:'w_childe',       region:'Mondstadt'},
  {id:'eula',         name:'Eula',            element:'Cryo',    rarity:5, weaponType:'Claymore', talentBook:'resistance',  weaponMat:'dandelion_gladiator',weeklyBoss:'w_azhdaha',       region:'Mondstadt'},
  {id:'fischl',       name:'Fischl',          element:'Electro', rarity:4, weaponType:'Bow',      talentBook:'ballad',      weaponMat:'dandelion_gladiator',weeklyBoss:'w_wolf',       region:'Mondstadt'},
  {id:'jean',         name:'Jean',            element:'Anemo',   rarity:5, weaponType:'Sword',    talentBook:'resistance',  weaponMat:'dandelion_gladiator',weeklyBoss:'w_dvalin',       region:'Mondstadt'},
  {id:'kaeya',        name:'Kaeya',           element:'Cryo',    rarity:4, weaponType:'Sword',    talentBook:'ballad',      weaponMat:'dandelion_gladiator',weeklyBoss:'w_wolf',       region:'Mondstadt'},
  {id:'klee',         name:'Klee',            element:'Pyro',    rarity:5, weaponType:'Catalyst', talentBook:'freedom',     weaponMat:'decarabian',       weeklyBoss:'w_wolf',         region:'Mondstadt'},
  {id:'lisa',         name:'Lisa',            element:'Electro', rarity:4, weaponType:'Catalyst', talentBook:'ballad',      weaponMat:'dandelion_gladiator',weeklyBoss:'w_dvalin',       region:'Mondstadt'},
  {id:'mona',         name:'Mona',            element:'Hydro',   rarity:5, weaponType:'Catalyst', talentBook:'resistance',  weaponMat:'dandelion_gladiator',weeklyBoss:'w_wolf',       region:'Mondstadt'},
  {id:'noelle',       name:'Noelle',          element:'Geo',     rarity:4, weaponType:'Claymore', talentBook:'resistance',  weaponMat:'dandelion_gladiator',weeklyBoss:'w_dvalin',       region:'Mondstadt'},
  {id:'razor',        name:'Razor',           element:'Electro', rarity:4, weaponType:'Claymore', talentBook:'resistance',  weaponMat:'dandelion_gladiator',weeklyBoss:'w_dvalin',       region:'Mondstadt'},
  {id:'rosaria',      name:'Rosaria',         element:'Cryo',    rarity:4, weaponType:'Polearm',  talentBook:'ballad',      weaponMat:'dandelion_gladiator',weeklyBoss:'w_childe',       region:'Mondstadt'},
  {id:'sucrose',      name:'Sucrose',         element:'Anemo',   rarity:4, weaponType:'Catalyst', talentBook:'freedom',     weaponMat:'dandelion_gladiator',weeklyBoss:'w_wolf',       region:'Mondstadt'},
  {id:'venti',        name:'Venti',           element:'Anemo',   rarity:5, weaponType:'Bow',      talentBook:'ballad',      weaponMat:'dandelion_gladiator',weeklyBoss:'w_wolf',       region:'Mondstadt'},
  {id:'traveler_anemo',name:'Traveler (Anemo)',element:'Anemo',  rarity:5, weaponType:'Sword',    talentBook:'freedom',     weaponMat:'dandelion_gladiator',weeklyBoss:'w_dvalin',       region:'Mondstadt'},
  {id:'varka',         name:'Varka',          element:'Anemo',   rarity:5, weaponType:'Claymore', talentBook:'freedom',     weaponMat:'dandelion_gladiator',weeklyBoss:'w_nod_krai',       region:'Mondstadt'},
  // ── Liyue ──
  {id:'beidou',       name:'Beidou',          element:'Electro', rarity:4, weaponType:'Claymore', talentBook:'gold',        weaponMat:'aerosiderite',     weeklyBoss:'w_dvalin',       region:'Liyue'},
  {id:'chongyun',     name:'Chongyun',        element:'Cryo',    rarity:4, weaponType:'Claymore', talentBook:'diligence',   weaponMat:'guyun',            weeklyBoss:'w_dvalin',       region:'Liyue'},
  {id:'ganyu',        name:'Ganyu',           element:'Cryo',    rarity:5, weaponType:'Bow',      talentBook:'diligence',   weaponMat:'aerosiderite',     weeklyBoss:'w_childe',      region:'Liyue'},
  {id:'hu_tao',       name:'Hu Tao',          element:'Pyro',    rarity:5, weaponType:'Polearm',  talentBook:'diligence',   weaponMat:'aerosiderite',     weeklyBoss:'w_childe',       region:'Liyue'},
  {id:'keqing',       name:'Keqing',          element:'Electro', rarity:5, weaponType:'Sword',    talentBook:'prosperity',  weaponMat:'aerosiderite',     weeklyBoss:'w_wolf',       region:'Liyue'},
  {id:'ningguang',    name:'Ningguang',       element:'Geo',     rarity:4, weaponType:'Catalyst', talentBook:'prosperity',  weaponMat:'guyun',            weeklyBoss:'w_wolf',       region:'Liyue'},
  {id:'qiqi',         name:'Qiqi',            element:'Cryo',    rarity:5, weaponType:'Sword',    talentBook:'prosperity',  weaponMat:'aerosiderite',     weeklyBoss:'w_wolf',       region:'Liyue'},
  {id:'shenhe',       name:'Shenhe',          element:'Cryo',    rarity:5, weaponType:'Polearm',  talentBook:'prosperity',  weaponMat:'guyun',            weeklyBoss:'w_signora',      region:'Liyue'},
  {id:'tartaglia',    name:'Tartaglia',       element:'Hydro',   rarity:5, weaponType:'Bow',      talentBook:'freedom',     weaponMat:'dandelion_gladiator',weeklyBoss:'w_childe',     region:'Liyue'},
  {id:'traveler_geo', name:'Traveler (Geo)',  element:'Geo',     rarity:5, weaponType:'Sword',    talentBook:'ballad',      weaponMat:'aerosiderite',     weeklyBoss:'w_wolf',      region:'Liyue'},
  {id:'xiangling',    name:'Xiangling',       element:'Pyro',    rarity:4, weaponType:'Polearm',  talentBook:'diligence',   weaponMat:'mist_veiled',      weeklyBoss:'w_dvalin',       region:'Liyue'},
  {id:'xiao',         name:'Xiao',            element:'Anemo',   rarity:5, weaponType:'Polearm',  talentBook:'prosperity',  weaponMat:'aerosiderite',     weeklyBoss:'w_childe',      region:'Liyue'},
  {id:'xinyan',       name:'Xinyan',          element:'Pyro',    rarity:4, weaponType:'Claymore', talentBook:'gold',        weaponMat:'aerosiderite',     weeklyBoss:'w_childe',       region:'Liyue'},
  {id:'xingqiu',      name:'Xingqiu',         element:'Hydro',   rarity:4, weaponType:'Sword',    talentBook:'gold',        weaponMat:'aerosiderite',     weeklyBoss:'w_wolf',       region:'Liyue'},
  {id:'yanfei',       name:'Yanfei',          element:'Pyro',    rarity:4, weaponType:'Catalyst', talentBook:'gold',        weaponMat:'aerosiderite',     weeklyBoss:'w_azhdaha',      region:'Liyue'},
  {id:'yaoyao',       name:'Yaoyao',          element:'Dendro',  rarity:4, weaponType:'Polearm',  talentBook:'diligence',   weaponMat:'mist_veiled',      weeklyBoss:'w_scaramouche',      region:'Liyue'},
  {id:'yelan',        name:'Yelan',           element:'Hydro',   rarity:5, weaponType:'Bow',      talentBook:'prosperity',  weaponMat:'aerosiderite',     weeklyBoss:'w_azhdaha',      region:'Liyue'},
  {id:'yoimiya',      name:'Yoimiya',         element:'Pyro',    rarity:5, weaponType:'Bow',      talentBook:'diligence',   weaponMat:'aerosiderite',     weeklyBoss:'w_azhdaha',      region:'Liyue'},
  {id:'yun_jin',      name:'Yun Jin',         element:'Geo',     rarity:4, weaponType:'Polearm',  talentBook:'diligence',   weaponMat:'guyun',            weeklyBoss:'w_signora',       region:'Liyue'},
  {id:'zhongli',      name:'Zhongli',         element:'Geo',     rarity:5, weaponType:'Polearm',  talentBook:'gold',        weaponMat:'aerosiderite',     weeklyBoss:'w_childe',       region:'Liyue'},
  {id:'baizhu',       name:'Baizhu',          element:'Dendro',  rarity:5, weaponType:'Catalyst', talentBook:'gold',        weaponMat:'aerosiderite',     weeklyBoss:'w_apep',      region:'Liyue'},
  {id:'gaming',       name:'Gaming',          element:'Pyro',    rarity:4, weaponType:'Claymore', talentBook:'prosperity',  weaponMat:'mist_veiled',      weeklyBoss:'w_narwhal',       region:'Liyue'},
  {id:'lan_yan',      name:'Lan Yan',         element:'Anemo',   rarity:4, weaponType:'Catalyst', talentBook:'diligence',   weaponMat:'aerosiderite',     weeklyBoss:'w_natlan',      region:'Liyue'},
  // ── Inazuma ──
  {id:'arataki_itto', name:'Arataki Itto',    element:'Geo',     rarity:5, weaponType:'Claymore', talentBook:'elegance',    weaponMat:'narukami',         weeklyBoss:'w_signora',      region:'Inazuma'},
  {id:'gorou',        name:'Gorou',           element:'Geo',     rarity:4, weaponType:'Bow',      talentBook:'light',       weaponMat:'narukami',         weeklyBoss:'w_signora',       region:'Inazuma'},
  {id:'heizou',       name:'Heizou',          element:'Anemo',   rarity:4, weaponType:'Catalyst', talentBook:'transience',  weaponMat:'kijin',            weeklyBoss:'w_raiden',       region:'Inazuma'},
  {id:'kazuha',       name:'Kazuha',          element:'Anemo',   rarity:5, weaponType:'Sword',    talentBook:'diligence',   weaponMat:'distant_sea',      weeklyBoss:'w_azhdaha',      region:'Inazuma'},
  {id:'ayaka',        name:'Ayaka',           element:'Cryo',    rarity:5, weaponType:'Sword',    talentBook:'elegance',    weaponMat:'narukami',         weeklyBoss:'w_azhdaha',      region:'Inazuma'},
  {id:'ayato',        name:'Ayato',           element:'Hydro',   rarity:5, weaponType:'Sword',    talentBook:'elegance',    weaponMat:'narukami',         weeklyBoss:'w_raiden',       region:'Inazuma'},
  {id:'kirara',       name:'Kirara',          element:'Dendro',  rarity:4, weaponType:'Sword',    talentBook:'transience',  weaponMat:'kijin',            weeklyBoss:'w_apep',      region:'Inazuma'},
  {id:'kujou_sara',   name:'Kujou Sara',      element:'Electro', rarity:4, weaponType:'Bow',      talentBook:'elegance',    weaponMat:'narukami',         weeklyBoss:'w_signora',      region:'Inazuma'},
  {id:'kuki_shinobu', name:'Kuki Shinobu',    element:'Electro', rarity:4, weaponType:'Sword',    talentBook:'elegance',    weaponMat:'narukami',         weeklyBoss:'w_raiden',      region:'Inazuma'},
  {id:'kokomi',       name:'Kokomi',          element:'Hydro',   rarity:5, weaponType:'Catalyst', talentBook:'transience',  weaponMat:'narukami',         weeklyBoss:'w_signora',      region:'Inazuma'},
  {id:'raiden_shogun',name:'Raiden Shogun',   element:'Electro', rarity:5, weaponType:'Polearm',  talentBook:'light',       weaponMat:'narukami',         weeklyBoss:'w_signora',      region:'Inazuma'},
  {id:'sayu',         name:'Sayu',            element:'Anemo',   rarity:4, weaponType:'Claymore', talentBook:'light',       weaponMat:'narukami',         weeklyBoss:'w_azhdaha',       region:'Inazuma'},
  {id:'thoma',        name:'Thoma',           element:'Pyro',    rarity:4, weaponType:'Polearm',  talentBook:'transience',  weaponMat:'narukami',         weeklyBoss:'w_signora',       region:'Inazuma'},
  {id:'traveler_electro',name:'Traveler (Electro)',element:'Electro',rarity:5,weaponType:'Sword', talentBook:'elegance',    weaponMat:'narukami',         weeklyBoss:'w_azhdaha',       region:'Inazuma'},
  {id:'yae_miko',     name:'Yae Miko',        element:'Electro', rarity:5, weaponType:'Catalyst', talentBook:'light',       weaponMat:'narukami',         weeklyBoss:'w_raiden',       region:'Inazuma'},
  // ── Sumeru ──
  {id:'alhaitham',    name:'Alhaitham',        element:'Dendro',  rarity:5, weaponType:'Sword',    talentBook:'ingenuity',   weaponMat:'copper_talisman',  weeklyBoss:'w_scaramouche',  region:'Sumeru'},
  {id:'candace',      name:'Candace',          element:'Hydro',   rarity:4, weaponType:'Polearm',  talentBook:'admonition',  weaponMat:'oasis_garden',     weeklyBoss:'w_raiden',         region:'Sumeru'},
  {id:'collei',       name:'Collei',           element:'Dendro',  rarity:4, weaponType:'Bow',      talentBook:'praxis',      weaponMat:'forest_dew',       weeklyBoss:'w_raiden',  region:'Sumeru'},
  {id:'cyno',         name:'Cyno',             element:'Electro', rarity:5, weaponType:'Polearm',  talentBook:'admonition',  weaponMat:'oasis_garden',     weeklyBoss:'w_raiden',         region:'Sumeru'},
  {id:'dehya',        name:'Dehya',            element:'Pyro',    rarity:5, weaponType:'Claymore', talentBook:'praxis',      weaponMat:'oasis_garden',     weeklyBoss:'w_scaramouche',  region:'Sumeru'},
  {id:'dori',         name:'Dori',             element:'Electro', rarity:4, weaponType:'Claymore', talentBook:'ingenuity',   weaponMat:'copper_talisman',  weeklyBoss:'w_azhdaha',  region:'Sumeru'},
  {id:'faruzan',      name:'Faruzan',          element:'Anemo',   rarity:4, weaponType:'Bow',      talentBook:'admonition',  weaponMat:'copper_talisman',  weeklyBoss:'w_scaramouche',  region:'Sumeru'},
  {id:'kaveh',        name:'Kaveh',            element:'Dendro',  rarity:4, weaponType:'Claymore', talentBook:'ingenuity',   weaponMat:'forest_dew',       weeklyBoss:'w_apep',  region:'Sumeru'},
  {id:'layla',        name:'Layla',            element:'Cryo',    rarity:4, weaponType:'Sword',    talentBook:'ingenuity',   weaponMat:'forest_dew',       weeklyBoss:'w_scaramouche',  region:'Sumeru'},
  {id:'mika',         name:'Mika',             element:'Cryo',    rarity:4, weaponType:'Polearm',  talentBook:'ballad',      weaponMat:'dandelion_gladiator',weeklyBoss:'w_scaramouche',       region:'Sumeru'},
  {id:'nahida',       name:'Nahida',           element:'Dendro',  rarity:5, weaponType:'Catalyst', talentBook:'ingenuity',   weaponMat:'forest_dew',       weeklyBoss:'w_scaramouche',  region:'Sumeru'},
  {id:'nilou',        name:'Nilou',            element:'Hydro',   rarity:5, weaponType:'Sword',    talentBook:'praxis',      weaponMat:'copper_talisman',  weeklyBoss:'w_raiden',         region:'Sumeru'},
  {id:'sethos',       name:'Sethos',           element:'Electro', rarity:4, weaponType:'Bow',      talentBook:'praxis',      weaponMat:'oasis_garden',     weeklyBoss:'w_scaramouche',         region:'Sumeru'},
  {id:'tighnari',     name:'Tighnari',         element:'Dendro',  rarity:5, weaponType:'Bow',      talentBook:'admonition',  weaponMat:'copper_talisman',  weeklyBoss:'w_raiden',         region:'Sumeru'},
  {id:'traveler_dendro',name:'Traveler (Dendro)',element:'Dendro', rarity:5, weaponType:'Sword',   talentBook:'admonition',  weaponMat:'copper_talisman',  weeklyBoss:'w_raiden',         region:'Sumeru'},
  {id:'wanderer',     name:'Wanderer',         element:'Anemo',   rarity:5, weaponType:'Catalyst', talentBook:'praxis',      weaponMat:'narukami',         weeklyBoss:'w_scaramouche',  region:'Sumeru'},
  // ── Fontaine ──
  {id:'arlecchino',   name:'Arlecchino',       element:'Pyro',    rarity:5, weaponType:'Polearm',  talentBook:'order',       weaponMat:'talisman_soldier', weeklyBoss:'w_knave',        region:'Fontaine'},
  {id:'charlotte',    name:'Charlotte',        element:'Cryo',    rarity:4, weaponType:'Catalyst', talentBook:'justice',     weaponMat:'talisman_soldier', weeklyBoss:'w_narwhal',        region:'Fontaine'},
  {id:'chevreuse',    name:'Chevreuse',        element:'Pyro',    rarity:4, weaponType:'Polearm',  talentBook:'order',       weaponMat:'broken_goblet',    weeklyBoss:'w_narwhal',        region:'Fontaine'},
  {id:'chiori',       name:'Chiori',           element:'Geo',     rarity:5, weaponType:'Sword',    talentBook:'light',       weaponMat:'talisman_soldier', weeklyBoss:'w_narwhal',      region:'Fontaine'},
  {id:'clorinde',     name:'Clorinde',         element:'Electro', rarity:5, weaponType:'Sword',    talentBook:'justice',     weaponMat:'talisman_soldier', weeklyBoss:'w_apep',        region:'Fontaine'},
  {id:'emilie',       name:'Emilie',           element:'Dendro',  rarity:5, weaponType:'Polearm',  talentBook:'order',       weaponMat:'ancient_chord',    weeklyBoss:'w_knave',      region:'Fontaine'},
  {id:'escoffier',    name:'Escoffier',        element:'Cryo',    rarity:5, weaponType:'Polearm',  talentBook:'justice',     weaponMat:'ancient_chord',    weeklyBoss:'w_natlan',        region:'Fontaine'},
  {id:'freminet',     name:'Freminet',         element:'Cryo',    rarity:4, weaponType:'Claymore', talentBook:'justice',     weaponMat:'broken_goblet',    weeklyBoss:'w_apep',      region:'Fontaine'},
  {id:'furina',       name:'Furina',           element:'Hydro',   rarity:5, weaponType:'Sword',    talentBook:'justice',     weaponMat:'talisman_soldier', weeklyBoss:'w_narwhal',      region:'Fontaine'},
  {id:'lynette',      name:'Lynette',          element:'Anemo',   rarity:4, weaponType:'Sword',    talentBook:'order',       weaponMat:'broken_goblet',    weeklyBoss:'w_apep',        region:'Fontaine'},
  {id:'lyney',        name:'Lyney',            element:'Pyro',    rarity:5, weaponType:'Bow',      talentBook:'equity',      weaponMat:'talisman_soldier', weeklyBoss:'w_apep',        region:'Fontaine'},
  {id:'navia',        name:'Navia',            element:'Geo',     rarity:5, weaponType:'Claymore', talentBook:'equity',      weaponMat:'broken_goblet',    weeklyBoss:'w_narwhal',      region:'Fontaine'},
  {id:'neuvillette',  name:'Neuvillette',      element:'Hydro',   rarity:5, weaponType:'Catalyst', talentBook:'equity',      weaponMat:'broken_goblet',    weeklyBoss:'w_apep',      region:'Fontaine'},
  {id:'sigewinne',    name:'Sigewinne',        element:'Hydro',   rarity:5, weaponType:'Bow',      talentBook:'equity',      weaponMat:'talisman_soldier', weeklyBoss:'w_narwhal',      region:'Fontaine'},
  {id:'traveler_hydro',name:'Traveler (Hydro)',element:'Hydro',   rarity:5, weaponType:'Sword',    talentBook:'justice',     weaponMat:'talisman_soldier', weeklyBoss:'w_apep',        region:'Fontaine'},
  {id:'wriothesley',  name:'Wriothesley',      element:'Cryo',    rarity:5, weaponType:'Catalyst', talentBook:'order',       weaponMat:'talisman_soldier', weeklyBoss:'w_apep',      region:'Fontaine'},
  {id:'xianyun',      name:'Xianyun',          element:'Anemo',   rarity:5, weaponType:'Catalyst', talentBook:'gold',        weaponMat:'mist_veiled',      weeklyBoss:'w_narwhal',      region:'Fontaine'},
  // ── Natlan ──
  {id:'chasca',       name:'Chasca',           element:'Anemo',   rarity:5, weaponType:'Bow',      talentBook:'conflict',    weaponMat:'night_wind',       weeklyBoss:'w_knave',       region:'Natlan'},
  {id:'citlali',      name:'Citlali',          element:'Cryo',    rarity:5, weaponType:'Catalyst', talentBook:'kindling',    weaponMat:'blazing_heart',    weeklyBoss:'w_knave',       region:'Natlan'},
  {id:'iansan',       name:'Iansan',           element:'Electro', rarity:4, weaponType:'Polearm',  talentBook:'contention',  weaponMat:'scorching_might',  weeklyBoss:'w_knave',       region:'Natlan'},
  {id:'ifa',          name:'Ifa',              element:'Anemo',   rarity:4, weaponType:'Catalyst', talentBook:'conflict',    weaponMat:'night_wind',       weeklyBoss:'w_nod_krai',       region:'Natlan'},
  {id:'kachina',      name:'Kachina',          element:'Geo',     rarity:4, weaponType:'Polearm',  talentBook:'conflict',    weaponMat:'scorching_might',  weeklyBoss:'w_knave',       region:'Natlan'},
  {id:'kinich',       name:'Kinich',           element:'Dendro',  rarity:5, weaponType:'Claymore', talentBook:'kindling',    weaponMat:'scorching_might',  weeklyBoss:'w_knave',       region:'Natlan'},
  {id:'mavuika',      name:'Mavuika',          element:'Pyro',    rarity:5, weaponType:'Claymore', talentBook:'contention',  weaponMat:'scorching_might',  weeklyBoss:'w_natlan',       region:'Natlan'},
  {id:'mualani',      name:'Mualani',          element:'Hydro',   rarity:5, weaponType:'Catalyst', talentBook:'contention',  weaponMat:'night_wind',       weeklyBoss:'w_narwhal',       region:'Natlan'},
  {id:'ororon',       name:'Ororon',           element:'Electro', rarity:4, weaponType:'Bow',      talentBook:'kindling',    weaponMat:'night_wind',       weeklyBoss:'w_narwhal',       region:'Natlan'},
  {id:'traveler_pyro',name:'Traveler (Pyro)',  element:'Pyro',    rarity:5, weaponType:'Sword',    talentBook:'conflict',    weaponMat:'scorching_might',  weeklyBoss:'w_natlan',       region:'Natlan'},
  {id:'varesa',       name:'Varesa',           element:'Electro', rarity:5, weaponType:'Catalyst', talentBook:'conflict',    weaponMat:'night_wind',       weeklyBoss:'w_natlan',       region:'Natlan'},
  {id:'xilonen',      name:'Xilonen',          element:'Geo',     rarity:5, weaponType:'Sword',    talentBook:'kindling',    weaponMat:'blazing_heart',    weeklyBoss:'w_scaramouche',       region:'Natlan'},
  // ── Nod-Krai ──
  {id:'mizuki',       name:'Mizuki',           element:'Anemo',   rarity:5, weaponType:'Catalyst', talentBook:'transience',  weaponMat:'artful_device',    weeklyBoss:'w_knave',     region:'Nod-Krai'},
  {id:'columbina',    name:'Columbina',        element:'Cryo',    rarity:5, weaponType:'Bow',      talentBook:'moonlight',   weaponMat:'far_north',        weeklyBoss:'w_heretic',     region:'Nod-Krai'},
  {id:'zibai',        name:'Zibai',            element:'Cryo',    rarity:5, weaponType:'Sword',    talentBook:'vagrancy',    weaponMat:'long_night',       weeklyBoss:'w_nod_krai',     region:'Nod-Krai'},
  {id:'illuga',       name:'Illuga',           element:'Electro', rarity:5, weaponType:'Claymore', talentBook:'elysium',     weaponMat:'artful_device',    weeklyBoss:'w_natlan',     region:'Nod-Krai'},
  {id:'skirk',        name:'Skirk',            element:'Cryo',    rarity:5, weaponType:'Sword',    talentBook:'contention',  weaponMat:'long_night',       weeklyBoss:'w_nod_krai',     region:'Nod-Krai'},
  {id:'ineffa',       name:'Ineffa',           element:'Electro', rarity:5, weaponType:'Polearm',  talentBook:'conflict',    weaponMat:'scorching_might',  weeklyBoss:'w_natlan',     region:'Nod-Krai'},
  {id:'aino',         name:'Aino',             element:'Hydro',   rarity:4, weaponType:'Claymore', talentBook:'elysium',     weaponMat:'far_north',        weeklyBoss:'w_knave',     region:'Nod-Krai'},
  {id:'flins',        name:'Flins',            element:'Electro', rarity:5, weaponType:'Polearm',  talentBook:'vagrancy',    weaponMat:'long_night',       weeklyBoss:'w_nod_krai',     region:'Nod-Krai'},
  {id:'lauma',        name:'Lauma',            element:'Dendro',  rarity:5, weaponType:'Catalyst', talentBook:'moonlight',   weaponMat:'artful_device',    weeklyBoss:'w_natlan',     region:'Nod-Krai'},
  {id:'nefer',        name:'Nefer',            element:'Hydro',   rarity:5, weaponType:'Catalyst', talentBook:'elysium',     weaponMat:'far_north',        weeklyBoss:'w_nod_krai',     region:'Nod-Krai'},
  {id:'jahoda',       name:'Jahoda',           element:'Pyro',    rarity:4, weaponType:'Sword',    talentBook:'vagrancy',    weaponMat:'long_night',       weeklyBoss:'w_nod_krai',     region:'Nod-Krai'},
  {id:'dahlia',       name:'Dahlia',           element:'Cryo',    rarity:5, weaponType:'Sword',    talentBook:'vagrancy',    weaponMat:'long_night',       weeklyBoss:'w_natlan',     region:'Nod-Krai'},
  // ── Special / Collab ──
  ...
  {id:'durin',        name:'Durin',            element:'Pyro',    rarity:5, weaponType:'Sword',    talentBook:'ballad',      weaponMat:'decarabian',       weeklyBoss:'w_natlan',       region:'Mondstadt'},
]
...
const W_BOSS  = 'https://static.wikia.nocookie.net/gensin-impact/images'
const PM_BOSS = 'https://paimon.moe/images'
export const WEEKLY_BOSSES_INFO = [
  // ── Mondstadt ──
  ...
  {id:'w_wolf',       label:'Andrius',                   region:'Mondstadt', sub:'Wolvendom',                       icon:`${W_BOSS}/a/a4/Andrius_Icon.png`},
  ...
  // ── Liyue ──
  {id:'w_childe',     label:'Tartaglia',                 region:'Liyue',     sub:'Golden House',                    icon:`${W_BOSS}/d/d9/Childe_P3_Icon.png`},
  {id:'w_azhdaha',    label:'Azhdaha',                   region:'Liyue',     sub:'Mt. Hulao',                       icon:`${W_BOSS}/1/18/Enemy_Azhdaha.png`},
  // ── Inazuma ──
  {id:'w_signora',    label:'La Signora',                region:'Inazuma',   sub:'Inazuma City',                    icon:`${W_BOSS}/5/57/NPC_Signora_Icon.png`},
  {id:'w_raiden',     label:'Raiden Shogun',             region:'Inazuma',   sub:'Grand Narukami Shrine',           icon:`${PM_BOSS}/characters/raiden_shogun.png`},
  // ── Sumeru ──
  {id:'w_scaramouche',label:'Scaramouche',               region:'Sumeru',    sub:'Chinvat Ravine',                  icon:`${PM_BOSS}/characters/wanderer.png`},
  ...
  {id:'w_knave',      label:'The Knave',                 region:'Fontaine',  sub:'Mont Esus East',                  icon:`${PM_BOSS}/characters/arlecchino.png`},
  // ── Natlan ──
